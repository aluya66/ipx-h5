...
export default {
    ...
    // 获取配置参数
        getBaseCofing () {
            ...
            let testData = {
                'token': '',
                'app_version': '1.2.0',
                'platform': 'web',
