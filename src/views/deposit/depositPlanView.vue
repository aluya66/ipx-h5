<template>
    <div class="plan-contain">
        <div class="plan-shadow">
            <div class="plan-header-con">
                <div class="plan-header">
                    <p class="plan-title">{{data.remark}}：付{{data.depositAmount}}押金</p>
                </div>
            </div>
            <div class="plan-conditions">
                <div class="condition">
                    <img src="../../themes/images/icon_consumption_quota@2x.png"/>
                    <div class="data">
                        <span class="number">{{data.consumeAmount}}</span><span class="unit">元</span>
                    </div>
                    <span>消费额度</span>
                </div>
                <div class="condition">
                    <img src="../../themes/images/icon_validity_period@2x.png"/>
                    <div class="data">
                        <span class="number">{{data.effectiveDays}}</span><span class="unit">天</span>
                    </div>
                    <span>押金有效期</span>
                </div>
                <div class="condition">
                    <img src="../../themes/images/icon_returns@2x.png"/>
                    <div class="data">
                        <span class="number">{{data.refundTimes}}</span><span class="unit">次</span>
                    </div>
                    <span>免费全场退货</span>
                </div>
                <div class="condition">
                    <img src="../../themes/images/icon_replacement_ratio@2x.png"/>
                    <div class="data"><span class="number">{{data.refundRate}}</span><span class="unit">%</span></div>
                    <span>退换货比例</span>
                </div>
            </div>
...
<style lang="less" scoped>
    ...
    .plan-shadow {
        text-align: center;
        box-shadow: 0 3px 20px 0 rgba(33, 44, 98, 0.12);
        background: url("../../themes/images/bg_deposit_plan.png") no-repeat;
        background-size: 100%;
        border-radius: 12px;
        margin-top: 8px;
        padding-bottom: 32px;
    ...
    .plan-contain {
        ...
        .plan-header-con {
            ...
            .plan-header {
                width: 235px;
                height: 40px;
                background: url("../../themes/images/bg_title_deposit@2x.png") no-repeat;
                background-size: 100%;
                text-align: center;
                margin-top: -8px;
