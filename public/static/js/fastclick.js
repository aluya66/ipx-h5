...
(function () {
  ...
  FastClick.prototype.onTouchStart = function (event) {
    let targetElement; let touch; let
      selection;
  ...
  FastClick.prototype.touchHasMoved = function (event) {
    const touch = event.changedTouches[0]; const
  ...
  FastClick.prototype.onTouchEnd = function (event) {
    let forElement; let trackingClickStart; let targetTagName; let scrollParent; let touch; let
